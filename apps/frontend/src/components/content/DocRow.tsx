...
import {IconDownload, IconEdit, IconExternalLink, IconStar, IconStarFilled, IconTrash} from "@tabler/icons-react";
...
export function DocRow({ doc, isSelected, persona, onSelect, onView, onFavorite, onDownload, onEdit, onDelete }: DocRowProps) {
    ...
    return (
        <Table.Tr style={{ cursor: 'pointer' }} onClick={() => onView(doc.url, doc.name, doc.id, isUrl)}>
            ...
            <Table.Td>{doc.id} {doc.jointagscontent}</Table.Td>
