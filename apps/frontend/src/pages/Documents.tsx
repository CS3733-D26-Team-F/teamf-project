...
export function Documents() {
    ...
    return (
        <>
            ...
            <Modal opened={filterOpen} onClose={() => setFilterOpen(false)} title="Filter Documents">
                <Stack>
                    ...
                    <MultiSelect label="Status" placeholder="All statuses" value={filterStatus}
                                 ...
                                 clearable/>
                    <MultiSelect label="File Type" placeholder="All types" value={filterType} onChange={setFilterType}
            ...
            <Modal opened={advancedTagsOpen} onClose={() => setAdvancedTagsOpen(false)} title="Advanced Tag Management"
                   size="lg">
                <Stack>
                    <ManageTags/>
                    <Group justify="flex-end" mt="md">
